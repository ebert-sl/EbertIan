...
namespace EbertIan.Controllers
{
    public class PagamentosComCartaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeDoCobrado,InformacoesAdicionais,NumeroDoCartao,Bandeira")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeDoCobrado,InformacoesAdicionais,NumeroDoCartao,Bandeira")] PagamentoComCartao pagamentoComCartao)
        {
